...
// When fetching data you are always adding state
export default class Players extends Component {
  ...
  render() {
    ...
    // Match, Location and History passed through 'this.props'
    return (
      <div className='container two-column'>
        ...
        {loading === false && location.pathname === '/players'
          ...
          : null}
        {/*
          Rendering a nested route.  No component, using render().
          Show the player, because this is the url you are at!
        */}
